...
Status: v1 in progress — spec is [issue #1](https://github.com/arthishaxom/lesvi/issues/1); scaffold, shelf registration, the scan/index/serve spine, the browsing pages (home feed + shelf pages), and agent metadata overrides (sidecar JSON + `lesvi:*` meta tags) are in place.
